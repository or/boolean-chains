...
#+link: hungry-search-at https://github.com/or/boolean-chains/blob/%s/src/hungry-search.cpp
#+link: full-search-at https://github.com/or/boolean-chains/blob/%s/src/full-search.cpp
#+link: old-full-search-at https://github.com/or/boolean-chains/blob/%s/src/boolean-chains-full-fast.cpp
...
given target functions, using the example of a 7-segment display for hexadecimal
digits; each segment is controlled by a boolean functions of the four inputs of
a 4-bit hexadecimal digit.
...
3. The index of the instruction based on the order Algorithm U generated them
   ...
   heuristic in its own right, but I haven't investigated this. I've used the
...
|           |     <r> |           <r> |           <r> |                       <r> |         <r> |      <r> |                        <r> |      <r> |
|-----------+---------+---------------+---------------+---------------------------+-------------+----------+----------------------------+----------|
| 10 digits |      11 |             3 |            40 |                 1,914,846 |  0.016 secs |     100% | MacBook Air 15" (M2, 2023) | [[full-search-at:c1bef22e][c1bef22e]] |
| 11 digits |      12 |            91 |         1,079 |                96,137,844 |   0.33 secs |     100% | MacBook Air 15" (M2, 2023) | [[full-search-at:c1bef22e][c1bef22e]] |
| 12 digits |      14 |             6 |            75 |            93,976,359,707 |   3.87 mins |     100% | MacBook Air 15" (M2, 2023) | [[full-search-at:c1bef22e][c1bef22e]] |
| 13 digits |      15 |             1 |             4 |         7,100,011,078,016 |  3.78 hours |     100% | MacBook Air 15" (M2, 2023) | [[full-search-at:c1bef22e][c1bef22e]] |
| 14 digits |      16 |            35 |            71 |     1,172,393,232,657,510 |    156 days |     100% |        AWS ECS, 1 vCPU/job | [[old-full-search-at:4ab3460f][4ab3460f]] |
| 15 digits |      17 |             1 |             1 |    30,968,277,080,052,517 |  3.93 years |          |        AWS ECS, 1 vCPU/job | [[old-full-search-at:4ab3460f][4ab3460f]] |
|           |         |               |               |    37,444,981,252,103,000 |  5.86 years |     100% |     BOINC Central, various | [[full-search-at:ba16ebb4][ba16ebb4]] |
| 16 digits |      18 |             0 |             0 | 2,567,815,524,926,566,380 |   450 years |     100% |     BOINC Central, various | [[full-search-at:ba16ebb4][ba16ebb4]] |
Note: the runs of 14 digits and the first 10% of the 15 digits on
AWS ECS use the version that didn't yet stop the branch after finding a
target function; that version generated about 70-80% more chains than the newer
version.
...
#+begin_export html
<details>
<summary>More info on verification and confidence</summary>

<p>For the 16 digit run I ran many batches via BOINC Central, each batch consisted of 1000 jobs, each job
consisted of 10 chunks. After many years of processing I encountered some obviously corrupted results, which
appear to have been caused by bit flips in memory, likely due to hardware failure or cosmic rays.
I ignored files from those hosts, but it worried me that this could have happened with other jobs,
without changing the result in a way that I would detect the corruption.</p>

<p>For that reason I re-ran a random sample of 3,556,138 chunks a second time to verify the results.
That's ~26% of all the 13,695,883 chunks of the search space. I also made sure that I included at least
one random chunk from every job. I found 19 chunks that differed from the first run. For those I verified
the result with a third run, discarded all the results of the job the problematic cases were part of,
and re-ran them.</p>

<p>Given those results I estimate a corruption chance of about 1 in 187,000 chunks. A missed solution would
have to lie in one of the 70-100 corrupt chunks of 13.696 million total chunks. It would also have to be
missed by the random verification sample of 3.556 million chunks, which verified at least one chunk of
every 10-chunk jobs. The probability of this should be about 1 in 250,000. Therefore I'm confident, that
there is no boolean chain of length 18 for this problem. The one of length 19 is optimal.

<p><b>Note</b>: The runtime in the table only includes the first valid run of every chunk. The verification
took another ~131 years in total.</p>
</details>
#+end_export
** Hungry search
:PROPERTIES:
...
|           |    <r> |          <r> |           <r> |              <r> |              <r> |                        <r> |      <r> |
|-----------+--------+--------------+---------------+------------------+------------------+----------------------------+----------|
| 10 digits |     12 |        1,155 |           483 |          220,311 |        4.58 secs | MacBook Air 15" (M2, 2023) | [[hungry-search-at:bdaa899d][bdaa899d]] |
| 11 digits |     12 |          182 |            47 |          264,537 |       11.17 secs | MacBook Air 15" (M2, 2023) | [[hungry-search-at:bdaa899d][bdaa899d]] |
| 12 digits |     14 |            4 |             3 |        4,072,870 |       13.72 mins | MacBook Air 15" (M2, 2023) | [[hungry-search-at:bdaa899d][bdaa899d]] |
...
|           |    <r> |          <r> |           <r> |              <r> |              <r> |                 <r> |      <r> |
|-----------+--------+--------------+---------------+------------------+------------------+---------------------+----------|
| 16 digits |     18 |            0 |             0 |      956,492,610 |         303 days | AWS ECS, 1 vCPU/job | [[hungry-search-at:60b931e0][60b931e0]] |
...
|           |    <r> |          <r> |           <r> |              <r> |              <r> |                 <r> |      <r> |
|-----------+--------+--------------+---------------+------------------+------------------+---------------------+----------|
| 15 digits |     17 |            0 |             0 |        8,197,343 |           7 days | AWS ECS, 1 vCPU/job | [[hungry-search-at:a78bc24a][a78bc24a]] |
| 15 digits |     18 |          493 |            48 |       11,202,690 |         23 hours | AWS ECS, 1 vCPU/job | [[hungry-search-at:3a616650][3a616650]] |
| 16 digits |     18 |            0 |             0 |       20,297,976 |           7 days | AWS ECS, 1 vCPU/job | [[hungry-search-at:60af8743][60af8743]] |
| 16 digits |     19 |           34 |            11 |       30,890,984 |         121 days | AWS ECS, 1 vCPU/job | [[hungry-search-at:34a00bda][34a00bda]] |
...
The same is true for the 16 digits search of length 18, its version was more
efficient than the one for length 19.
...
|           |    <r> |          <r> |           <r> |              <r> |              <r> |      <r> |                    <r> |      <r> |
|-----------+--------+--------------+---------------+------------------+------------------+----------+------------------------+----------|
| 16 digits |     18 |            0 |             0 |   39,660,805,920 |      20.54 years |   100.0% | BOINC Central, various | [[hungry-search-at:ba16ebb4][ba16ebb4]] |
...
digits. Nonetheless this is no proof, so I did an exhaustive search for 16
digits, see above.
...
exhaustive. The exhaustive search for a chain of length 18 proves these chain
lengths are optimal.
...
:END:
The minimal length of Boolean chains for the 7-segment display of hexadecimal
digits is 19, as found by the Hungry Search in approximately 121 computing days.
An exhaustive search subsequently confirmed that no chains of length 18 exist;
this computation required roughly 450 computing years.
* Source code
:PROPERTIES:
