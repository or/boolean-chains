...
:END:
My latest version of this program processes around 550-570 million chains per
second on my MacBook Air (M2, 2023). On AWS Batch with Fargate capacity on 1
vCPU it processes around 220-230 million chains per second; so about 56-59
