...
I wrote that original program with a class-based style, some templating, naive
sets, etc. -- all very slow compared to the latest version of exhaustive search.
...
:END:
|           | optimal length | number of optimal function sets |          number of chains generated |    computation time |                  computing |
|           |            <r> |                             <r> |                                 <r> |                 <r> |                        <r> |
|-----------+----------------+---------------------------------+-------------------------------------+---------------------+----------------------------|
| 10 digits |             11 |                               3 |                           7,461,658 |           0.03 secs | MacBook Air 15" (M2, 2023) |
| 11 digits |             12 |                              91 |                         344,252,541 |           0.78 secs | MacBook Air 15" (M2, 2023) |
| 12 digits |             14 |                               6 |                     263,675,232,692 |              9 mins | MacBook Air 15" (M2, 2023) |
| 13 digits |             15 |                               1 |                  15,586,512,093,540 |                     | MacBook Air 15" (M2, 2023) |
| 14 digits |             16 |                              35 |               1,172,393,232,657,510 |            156 days |        AWS ECS, 1 vCPU/job |
| 15 digits |             17 |                [known so far] 1 | [41%]        24,626,476,491,872,918 | [41%]     1002 days |        AWS ECS, 1 vCPU/job |
...
|           | length | number of chains found | number of chains generated | computation time |                  computing |
|           |    <r> |                    <r> |                        <r> |              <r> |                        <r> |
|-----------+--------+------------------------+----------------------------+------------------+----------------------------|
| 10 digits |     12 |                   1387 |                    200,246 |        3.11 secs | MacBook Air 15" (M2, 2023) |
| 11 digits |     12 |                    192 |                    221,833 |        7.55 secs | MacBook 15" Air (M2, 2023) |
| 12 digits |     14 |                      3 |                  6,182,486 |          15 mins | MacBook 15" Air (M2, 2023) |

With bite sizes 10, 9, 8, ...
|           | length | number of chains found | number of chains generated | computation time |           computing |
|           |    <r> |                    <r> |                        <r> |              <r> |                 <r> |
|-----------+--------+------------------------+----------------------------+------------------+---------------------|
| 15 digits |     18 |                    493 |                 11,237,970 |         14 hours | AWS ECS, 1 vCPU/job |
| 16 digits |     19 |                     34 |                 31,163,144 |          98 days | AWS ECS, 1 vCPU/job |
** Branching
:PROPERTIES:
