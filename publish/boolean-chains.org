...
:CUSTOM_ID: 15-digits
:END:
Total chains generated: 22,471,749,755,050,052 [~38% done]

Number of unique optimal sets of functions of length 17: 1 [so far]
...
1313 unique chains of length 18 that the hungry search found: [[file:chains-15-22.txt]].
