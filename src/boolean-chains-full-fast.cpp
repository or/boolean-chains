...
constexpr uint32_t TARGET_1 =
    (((uint32_t)0b0001011110011010) >> (16 - N)) & TAUTOLOGY;
constexpr uint32_t TARGET_2 =
    (((uint32_t)0b0110001111101000) >> (16 - N)) & TAUTOLOGY;
constexpr uint32_t TARGET_3 =
    (((uint32_t)0b0101101100100110) >> (16 - N)) & TAUTOLOGY;
constexpr uint32_t TARGET_4 =
    (((uint32_t)0b0011111000101001) >> (16 - N)) & TAUTOLOGY;
